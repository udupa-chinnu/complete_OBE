...
const initialForms: FeedbackForm[] = [
  {
    ...
    description: "Feedback regarding campus facilities and infrastructure.",
    questions: [
      { id: 1, text: "The classrooms are well-equipped with modern teaching aids.", type: "rating" },
      { id: 2, text: "The library has adequate resources for academic needs.", type: "rating" },
      { id: 3, text: "The computer labs are well-maintained and accessible.", type: "rating" },
    ],
  },
  {
    id: 2,
    ...
    description: "Evaluation of administrative support and processes.",
    questions: [
      { id: 1, text: "The administrative staff is helpful and responsive.", type: "rating" },
      { id: 2, text: "The admission process is well-organized and efficient.", type: "rating" },
    ],
  },
]
...
export default function InstitutionFeedbackPage() {
  ...
  const handleSave = () => {
    if (!formTitle || !formTargetAudience || !formSemester) {
  ...
  const handleEdit = (form: FeedbackForm) => {
    ...
    setFormTargetAudience(form.targetAudience)
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="w-[20%] min-w-[150px]">Target Audience</TableHead>
        ...
        <TabsContent value="create" className="w-full mt-0">
          <Card className="w-full border shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                {isEditing ? "Update the existing form details below" : "Design a new institution feedback form"}
              </CardDescription>
            </CardHeader>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formTargetAudience} onValueChange={setFormTargetAudience}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Students & Faculty">Students & Faculty</SelectItem>
        ...
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription className="flex items-center gap-2 mt-2">
              <Badge variant="outline">{viewForm?.targetAudience}</Badge>
              <span>•</span>
