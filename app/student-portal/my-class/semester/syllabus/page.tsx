    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <h1 className="text-2xl font-semibold mb-2 text-gray-800">Syllabus — Semester {sem}</h1>
            <p className="text-sm text-gray-500">Syllabus PDF links and topics list will be shown here.</p>
        </div>
      </div>
    </div>
  )
