...
export default function MissionPage() {
  ...
  const handleSave = () => {
    alert("Mission data saved successfully!")
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-xl font-bold text-purple-600">Mission Management</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {formulationFile && (
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-2">
                  <p className="text-sm text-purple-600">Selected: {formulationFile.name}</p>
                </div>
              )}
            </div>
                ...
                <div key={index} className="border border-gray-200 rounded-lg p-4 space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border border-gray-300 rounded-lg p-3">
                      ...
                      {mom.file && <p className="text-sm text-purple-600 mt-1">Selected: {mom.file.name}</p>}
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="flex justify-center">
              <Button onClick={handleSave} className="bg-purple-600 hover:bg-purple-700 px-8 py-3 text-lg">
                Save Mission
              </Button>
            </div>
          </CardContent>
