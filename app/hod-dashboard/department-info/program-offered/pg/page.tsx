...
export default function PGProgramPage() {
  ...
  const [programDuration, setProgramDuration] = useState("2")
  ...
  const handleSave = () => {
    alert("PG Program data saved successfully!")
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-xl font-bold text-green-600">Post Graduate (PG) Program</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={setProgramName}>
                ...
                <SelectContent>
                  <SelectItem value="Master of Business Administration (MBA)">
                    Master of Business Administration (MBA)
                  </SelectItem>
                  <SelectItem value="Master of Technology in Computer Science and Engineering">
                    Master of Technology in Computer Science and Engineering
                  </SelectItem>
                  <SelectItem value="Master of Technology in Electronics and Communication Engineering">
                    Master of Technology in Electronics and Communication Engineering
                  </SelectItem>
                  <SelectItem value="Master of Technology in Mechanical Engineering">
                    Master of Technology in Mechanical Engineering
                  </SelectItem>
                  <SelectItem value="Master of Technology in Civil Engineering">
                    Master of Technology in Civil Engineering
                  </SelectItem>
                  <SelectItem value="Master of Science in Computer Science">
                ...
                <div key={index} className="border border-gray-200 rounded-lg p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      {approval.file && <p className="text-sm text-green-600 mt-1">Selected: {approval.file.name}</p>}
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="space-y-2">
              ...
              <div className="border border-gray-300 rounded-lg p-3">
                ...
                {closureLetterFile && <p className="text-sm text-green-600 mt-1">Selected: {closureLetterFile.name}</p>}
              </div>
            </div>
