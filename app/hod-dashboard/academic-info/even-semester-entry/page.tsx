...
export default function EvenSemesterEntryPage() {
  ...
  const getSchemePrefix = (scheme: string, semester: string) => {
    const prefixes: { [key: string]: { [key: string]: string } } = {
      "2015 Scheme": { "4": "15", "6": "15", "8": "15" },
      "2017 Scheme": { "4": "17", "6": "17", "8": "17" },
      "2018 Scheme": { "4": "18", "6": "18", "8": "18" },
      Other: { "4": "XX", "6": "XX", "8": "XX" },
    }
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Even Semester Course Entry</h1>
              <p className="text-sm text-gray-600">Enter courses for semesters 4, 6, and 8</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>Choose a semester to enter courses (complete in order: 4 → 6 → 8)</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        {/* Final Submission */}
        {completedSemesters.length === 3 && (
          <Card className="mb-8 p-4 bg-green-100 border-green-300">
            <h3 className="font-semibold text-green-800 mb-2">✓ All Semesters Completed!</h3>
            <p className="text-sm text-green-700 mb-4">
              You have successfully configured all even semesters. Your academic information is now complete.
            </p>
            <Button className="w-full bg-green-600 hover:bg-green-700" onClick={() => router.push("/hod-dashboard")}>
        ...
        {completedSemesters.length < 3 && (
          <div className="flex justify-between">
            ...
            <Button className="bg-gray-400 hover:bg-gray-400" disabled>
              Complete all semesters first
            </Button>
          </div>
        )}
      </div>
